...
one_hot_encoder = pickle.load(open(r'D:\FAANG _SP\one_hot_encoder.pkl', 'rb'))
debt_to_equity_label_encoder = pickle.load(open(r'D:\FAANG _SP\debt_to_equity_label_encoder.pkl', 'rb'))
eps_label_encoder = pickle.load(open(r'D:\FAANG _SP\eps_label_encoder.pkl', 'rb'))
market_cap_label_encoder = pickle.load(open(r'D:\FAANG _SP\market_cap_label_encoder.pkl', 'rb'))
pe_ratio_label_encoder = pickle.load(open(r'D:\FAANG _SP\pe_ratio_label_encoder.pkl', 'rb'))
price_to_book_ratio_label_encoder = pickle.load(open(r'D:\FAANG _SP\price_to_book_ratio_label_encoder.pkl', 'rb'))
...
market_cap_encoded, pe_ratio_encoded, eps_encoded,
debt_to_equity_encoded, price_to_book_ratio_label_encoded,
